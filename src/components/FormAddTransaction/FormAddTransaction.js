...
// import { formAddTransactionSchema } from "../../utils/formAddValidation"
    ...
    <>
      <form onSubmit={handleSubmit} className={styles.form}>
        ...
        <div className={styles.categoriesContainer}>
          {/* <button className={styles.addCategory} onClick={(event) => dispatch(showModal())}> Add category</button> */}
        ...
        <Button text='Cancel' color='white' onClick={resetForm} />
      </form>
    </>
  );
}
